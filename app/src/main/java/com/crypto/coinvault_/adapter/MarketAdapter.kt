...
import com.crypto.coinvault_.databinding.CurrencyItemLayoutBinding
import com.crypto.coinvault_.models.CryptoCurrency
import com.crypto.coinvault_.R
import com.crypto.coinvault_.fragment.HomeFragmentDirections
import com.crypto.coinvault_.fragment.MarketFragment
import com.crypto.coinvault_.fragment.MarketFragmentDirections
import com.crypto.coinvault_.fragment.WatchListFragment
import com.crypto.coinvault_.fragment.WatchListFragmentDirections
...
class MarketAdapter(var context: Context, var list: List<CryptoCurrency>, var type: String) : RecyclerView.Adapter<MarketAdapter.MarketViewHolder>() {
    ...
    fun upadateData(dataItem : List<CryptoCurrency>){
        list = dataItem
